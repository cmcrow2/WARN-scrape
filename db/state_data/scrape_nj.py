...
import math
from constants.urls import nj
from helpers.find_last_page import find_last_page

def get_newjersey_data():
    url = find_last_page(nj)
    newjersey_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "New Jersey"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "New Jersey"
    ...
    print('New Jersey scrape successfull........')
    return newjersey_db