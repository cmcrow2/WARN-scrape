...
def get_michigan_data():
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Michigan"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Michigan"
    ...
    print('Michigan scrape successfull........')
    return michigan_db