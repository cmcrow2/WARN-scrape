...
import math
from constants.urls import ri
from helpers.find_last_page import find_last_page

def get_rhodeisland_data():
    url = find_last_page(ri)
    rhodeisland_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Rhode Island"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Rhode Island"
                ...
                rhodeisland_db.append(temp_data)
    ...
    print('Rhode Island scrape successfull........')
    return rhodeisland_db
