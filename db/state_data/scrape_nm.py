...
import math
from constants.urls import nm
from helpers.find_last_page import find_last_page

def get_newmexico_data():
    url = find_last_page(nm)
    newmexico_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "New Mexico"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "New Mexico"
    ...
    print('New Mexico scrape successfull........')
    return newmexico_db