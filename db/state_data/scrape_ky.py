...
import math
from constants.urls import ky
from helpers.find_last_page import find_last_page

def get_kentucky_data():
    url = find_last_page(ky)
    kentucky_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Kentucky"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Kentucky"
    ...
    print('Kentucky scrape successfull........')
    return kentucky_db
