...
import math
from constants.urls import sc
from helpers.find_last_page import find_last_page

def get_southcarolina_data():
    url = find_last_page(sc)
    southcarolina_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "South Carolina"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "South Carolina"
                ...
                southcarolina_db.append(temp_data)
    ...
    print('South Carolina scrape successfull........')
    return southcarolina_db
