...
import math
from constants.urls import vt
from helpers.find_last_page import find_last_page

def get_vermont_data():
    url = find_last_page(vt)
    vermont_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Vermont"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Vermont"
    ...
    print('Vermont scrape successfull........')
    return vermont_db
