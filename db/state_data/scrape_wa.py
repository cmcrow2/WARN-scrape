...
import math
from constants.urls import wa
from helpers.find_last_page import find_last_page

def get_washington_data():
    url = find_last_page(wa)
    washington_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Washington"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Washington"
                ...
                washington_db.append(temp_data)
    ...
    print('Washington scrape successfull........')
    return washington_db
