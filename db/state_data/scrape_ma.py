...
def get_massachusetts_data():
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Massachusetts"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Massachusetts"
                ...
                massachusetts_db.append(temp_data)
    ...
    print('Massachusetts scrape successfull........')
    return massachusetts_db