...
import math
from constants.urls import md
from helpers.find_last_page import find_last_page

def get_maryland_data():
    url = find_last_page(md)
    maryland_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Maryland"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Maryland"
    ...
    print('Maryland scrape successfull........')
    return maryland_db
