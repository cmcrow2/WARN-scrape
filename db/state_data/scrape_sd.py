...
import math
from constants.urls import sd
from helpers.find_last_page import find_last_page

def get_southdakota_data():
    url = find_last_page(sd)
    southdakota_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "South Dakota"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "South Dakota"
                ...
                southdakota_db.append(temp_data)
    ...
    print('South Dakota scrape successfull........')
    return southdakota_db
