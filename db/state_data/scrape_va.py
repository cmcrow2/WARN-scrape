...
import math
from constants.urls import va
from helpers.find_last_page import find_last_page

def get_virginia_data():
    url = find_last_page(va)
    virginia_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Virginia"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Virginia"
    ...
    print('Virginia scrape successfull........')
    return virginia_db
