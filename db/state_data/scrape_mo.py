...
import math
from constants.urls import mo
from helpers.find_last_page import find_last_page

def get_missouri_data():
    url = find_last_page(mo)
    missouri_db = []
    ...
    while True:
        ...
        for idx in reversed(warn_data["Reporting State"]):
            if (warn_data["Reporting State"][idx] == "Missouri"):
                temp_data = {}
                temp_data['id'] = count
                count += 1
                temp_data["state"] = "Missouri"
                ...
                if (not isinstance((warn_data["Starting Date"][idx]), str) and math.isnan(warn_data["Starting Date"][idx])):
                    ...
                    if (warn_data["Starting Date"][idx] == 'March 20, 202'):
                        warn_data["Starting Date"][idx] = 'March 20, 2020'
    ...
    print('Missouri scrape successfull........')
    return missouri_db